...
namespace LinkDev.DatingApp.Presistence.Migrations
{
    ...
    [Migration("20210628160808_updatePhotosEntity")]
    partial class updatePhotosEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinkDev.DatingApp.Core.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LinkDev.DatingApp.Core.Photo", b =>
                {
                    b.HasOne("LinkDev.DatingApp.Core.AppUser", "User")
                        .WithMany("Photos")
